...
<div class="formtitle">Manage Resources</div>

<form id ="pickForm" method="post" enctype="multipart/form-data" accept-charset=utf-8>

<div class="itemholder">
<div class="formlabel">File Upload</div><div class="formdisplay"><input type="file" name="file" class="textclass2" id="file" onclick="clearResults()"></div>
</div>
...
<div class="update" id="create" onclick="postFile()">Add New File</div><a href="/kejani/allproperty.html"><div class="update" id="delete">Back to Manage Resources</div></a>

<div class="formholder2" id="listData">

<div class="formtitle">Property Files</div>

<c:if test="${!empty resourcesByProperty}">
<c:forEach var="rc" items="${resourcesByProperty}">

<div class="itemholder">
<div class="formlabelx"> <img src="led-icons/accept.png"/> &nbsp; ${rc.fileName} </div>
</div>
