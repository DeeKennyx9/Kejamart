...
<script type="text/javascript">
    ...
    $(document).ready(function() {
		...
		$().ready(function() {
			...
			$.ajax({
				url: contexPath + "/propertylogo.html",
   			  	type: "GET",
...
<div class="formtitle">Add Logo</div>

<form id ="logoForm" method="post" enctype="multipart/form-data" accept-charset=utf-8>
...
<div class="update" id="create" onclick="postLogo()">Add Picture</div><a href="/kejani/allproperty.html"><div class="update" id="delete">Back to Manage Properties</div></a>

<div class="formholder2" id="listData">

<div class="formtitle">Property Logo</div>

<c:if test="${!empty picsByProperty}">
<c:forEach var="pc" items="${picsByProperty}">

<div class="picholderx"><img src="${pc.logo}" ${pc.orientation} /></div>
