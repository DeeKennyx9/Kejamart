...
<div class="formtitle">Manage Pictures</div>
...
<div class="update" id="create" onclick="postPics()">Add Picture</div><a href="/kejani/allproperty.html"><div class="update" id="delete">Back to Manage Properties</div></a>

<div class="formholder2" id="listData">

<div class="formtitle">Property Pictures</div>

<c:if test="${!empty picsByProperty}">
<c:forEach var="pc" items="${picsByProperty}">

<div class="picholder"><img src="${pc.path}" ${pc.orientation} /></div>
