...
$(document).ready(function() {
    ...
    $(deleteLink).click(function(event) {    
        ...
        $.ajax({
	        ...
	        window.location = contexPath + "/request.html";
...
<form:form method="post" commandName="alerts" id="deletereqForm"> 
...
<div class="formdisplay">
<form:input path="bedrooms" id="bedrooms" readonly="true" cssClass="textclassx"></form:input>
</div>
</div>
<div id ="dbed" class="dialogue"></div>

<a><div class="update" id="delete">Delete Request</div></a><a href="/kejani/request.html"><div class="update" id="delete">Back to Requests</div></a>
