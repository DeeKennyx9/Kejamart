...
<script type="text/javascript">
    ...
    $(document).ready(function() {
		...
		$().ready(function() {
			...
			$.ajax({
				url: contexPath + "/picturelist.html",
   			  	type: "GET",
...
<th><div class="listclass2">Property Name</div></th>
<th><div class="listclass8">Path</div></th>
<th><div class="listclass2">Publish Property</div></th>
</tr>
...
<form id="picForm" action="publishprops.html" method="get" accept-charset=utf-8>
<th><div class="listclass3"><img src="led-icons/pin.png"></div></th>
<input type="hidden" name="id" id="id" value="${pr.id}">
<th><input type="text" class="listclass" id="name" name="name" value="${pr.name}"></th>
<th><input type="text" class="listclass9" id="path" name="path" value="${pr.path}"></th>
<th><div class="listclass3"><input type="image" name="submit" src="led-icons/wand.png"></div></th>
</form>
