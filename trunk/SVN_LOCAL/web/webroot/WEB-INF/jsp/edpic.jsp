...
<form method="post" enctype="multipart/form-data" accept-charset=utf-8 onsubmit="validateUpload();">
...
<div class="formlabel">Picture 1</div><div class="formdisplay"><input type="file" name="fileUpload" class="textclass2" id="photo1" value="${prop.photo1}"></div>
</div>
...
<div class="update" id="update" onclick="editProp()">Edit Property</div><a href="/kejani/picturelist.html"><div class="update" id="delete">Back to Picture List</div></a>
