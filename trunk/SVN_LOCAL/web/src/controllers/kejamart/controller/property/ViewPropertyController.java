...
import kejamart.model.RangeAmount;
	...
	@Controller
	public class ViewPropertyController implements Settings {
		...
		public static Logger logger = Logger.getLogger(ViewPropertyController.class);	
		...
		@RequestMapping(value = "/viewproperty2.html", headers = "Accept=*/*", method=RequestMethod.GET)
		...
		@RequestMapping(value = "/viewproperty3.html", headers = "Accept=*/*", method=RequestMethod.GET)
